...
var ASM_CONSTS = {
  96712: () => { if (document.fullscreenElement) return 1; },  
 96758: () => { return document.getElementById('canvas').width; },  
 96810: () => { return parseInt(document.getElementById('canvas').style.width); },  
 96878: () => { document.exitFullscreen(); },  
 96905: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 96978: () => { if (document.fullscreenElement) return 1; },  
 97024: () => { return document.getElementById('canvas').width; },  
 97076: () => { return screen.width; },  
 97101: () => { document.exitFullscreen(); },  
 97128: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 97261: () => { return window.innerWidth; },  
 97287: () => { return window.innerHeight; },  
 97314: () => { if (document.fullscreenElement) return 1; },  
 97360: () => { return document.getElementById('canvas').width; },  
 97412: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97480: () => { if (document.fullscreenElement) return 1; },  
 97526: () => { return document.getElementById('canvas').width; },  
 97578: () => { return screen.width; },  
 97603: () => { return window.innerWidth; },  
 97629: () => { return window.innerHeight; },  
 97656: () => { if (document.fullscreenElement) return 1; },  
 97702: () => { return document.getElementById('canvas').width; },  
 97754: () => { return screen.width; },  
 97779: () => { document.exitFullscreen(); },  
 97806: () => { if (document.fullscreenElement) return 1; },  
 97852: () => { return document.getElementById('canvas').width; },  
 97904: () => { return parseInt(document.getElementById('canvas').style.width); },  
 97972: () => { document.exitFullscreen(); },  
 97999: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 98057: () => { return screen.width; },  
 98082: () => { return screen.height; },  
 98108: () => { return window.screenX; },  
 98135: () => { return window.screenY; },  
 98162: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 98215: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 98286: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 98343: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 98599: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 98670: () => { if (document.fullscreenElement) return 1; },  
 98716: () => { return window.innerWidth; },  
 98742: () => { return window.innerHeight; },  
 98769: () => { if (document.pointerLockElement) return 1; }
};
